...
contract NftMarketplace is ReentrancyGuard {
    ...
    // Chalange: Have this contract accpt payment in a subset of tokens as well
    // Hint: Use Chainlink Price Feeds to convert the price between tokens
    ...
    function listItem(
        ...
        // to sell the NFT for them. <— (used this way)
        IERC721 nft = IERC721(nftAddress);
